 ...
 * @option 隐藏
 * @value 0
 * @desc 是否在战斗中展示“敌人信息”指令
 * 你可以使用插件指令改变本项目，0 隐藏 1 显示
 * @default 1
 * 
 ...
 * @option 战斗结束时
 * @value 2
 * @desc 设置敌人信息何时被记录在图鉴中
 * 0:不记录, 1:战斗开始时, 2:战斗结束时
 * @default 2
 * 
 ...
 * @option 关闭
 * @value 0
 * @desc 是否在敌人图鉴、敌人信息中展示当前 HP 等信息
 * 你可以使用插件指令改变本项目 0:关闭、1:开启
 * @default 0
 * 
 * @param HideUnknownStatusInSkill
 * @text 使用检查敌人信息技能时隐藏未知敌人的状态
 * @type select
 * @option 开启
 * @value 1
 * @option 关闭
 * @value 0
 * @desc 未知敌人在使用检查敌人信息技能时是否隐藏状态 0:关闭、1:开启
 * @default 0
 * 
 * @param ShowGeneralStatusInSkill
 * @text 使用检查敌人信息技能时展示非战斗状态信息
 * @type select
 * @option 开启
 * @value 1
 * @option 关闭
 * @value 0
 * @desc 使用检查敌人信息技能时是否展示非战斗状态信息 (一般状态 <--> 当前状态)
 * @default 0
 * 
 ...
 * @text 敌人检查失败时的文本
 * @desc 当使用检查敌人信息技能，但敌人不能被记录到图鉴上时的文本 %1......表示敌人名
 * @default %1 无法被检查！

 * @param MissToAddEnemySkillMessage
 * @text 记录敌人技能未命中时的文本
 * @desc 记录敌人技能未命中时的文本. %1......表示敌人名
 * @default 登记 %1 失败了！
 * 
 * @param FailToCheckEnemySkillMessage
 * @text 检查敌人信息技能未命中时的文本
 * @desc 检查敌人信息技能未命中时的文本. %1......表示敌人名
 * @default 检查 %1 状态失败了！
 * 
 * @param ---显示项目---
 * @default 
 ...
 * ============================================================================
 * 
 * 本插件基于Mr.Yoji Ojima制作的"EnemyBook.js"开发。
 * 
 * 
 * 
 * 本插件功能包括
 * 
 * 1. 打开Enemybook场景
 * 2. 显示"EnemyBook.js"中未包含的更多状态
 * 3. 在战斗场景中添加"敌人信息"和"敌人图鉴"命令
 * 4. 新增 "检查敌人" 技能和 "记录敌人" 技能
 * 
 * 可显示的项目包括：
 * 敌人名称
 * 敌人精灵图
 ...
 * 1. 敌人图鉴
 * 显示      : 图鉴中注册的所有敌人
 * 玩家操作  : 使用物品、与人交谈、在战斗场景中使用"敌人图鉴"命令
 * 
 * 2. 战斗场景中的敌人当前信息
 * 显示       : 战斗成员列表。当前状态，如当前HP
 * 玩家操作   : 在战斗场景中使用"敌人信息"命令
 * 设置       : 打开 在敌人图鉴中展示当前状态
 * 
 * 3. 战斗场景中的敌人非当前信息
 * 显示       : 战斗成员列表。非当前状态
 ...
 * 玩家操作  : 使用 检查敌人信息技能
 * 
 * 5. 检查敌人信息技能 (一般信息) - v1.24
 * 显示      : 目标敌人的当前状态
 * 玩家操作  : 使用 检查敌人信息技能
 * 设置      : 打开 使用检查敌人信息技能时展示非战斗状态信息
 * 
 * ============================================================================
 * 如何使用
 * ============================================================================
 ...
 * 使用插件指令 "打开敌人图鉴"!
 * 
 * 玩家在战斗中遇到有名字的敌人时，该敌人会被记录。 
 * （对于不想记录的敌人，需要进行设置。）
 * 
 * 但默认情况下，需要显示的项目太多，空间不足。请在插件参数中移除一些项目。
 * 
 * ============================================================================
 * 其他功能
 * ============================================================================
 ...
 * 2. 使用插件参数 - v1.04
 *   打开参数 “在插件参数中使用元素图标”
 *   并在"元素图标"中输入以空格分隔的图标编号。 
 *   示例：76 64 65 66 67 68 69 70 71
 * 
 * 〇 未知敌人名 "???"
 * 
 * 如果玩家在敌人尚未注册时打开图鉴，
 * 图鉴会在名称和状态处显示"???"。可以通过设置插件参数更改"???"这个词
 * 
 * 〇当前状态设置和敌人信息命令 
 * 
 * 使用"敌人信息"命令时，默认显示非战斗数据。
 * 当您将插件参数'在"敌人信息"中显示当前状态'设置为开启时，将显示当前数据。 
 * 不仅显示当前HP，还显示ATK和元素率的变化。可以在游戏中通过插件命令更改设置。
 *  
 * 〇当前状态和检查技能 - v1.24
 * 
 * 使用"检查敌人信息"技能时，默认显示目标敌人的当前数据。
 * 您可以通过开启插件参数' 在"检查技能"中显示非战斗状态'来更改显示非战斗状态。
 * 
 * 
 * 〇记录时机
 * 
 * 可以通过设置插件参数"记录时机"来设置记录时机。 
 * 
 * 0: 从不 
 * 1: 战斗开始时 
 * 2: 战斗结束时
 * 
 * 〇获得前隐藏掉落物 - v1.22 
 * 可以通过插件参数"获得前隐藏掉落物"将玩家尚未获得的物品名称显示为 "???"。
 * 
 * ============================================================================
 * 插件指令
 * ============================================================================
 ...
 * 〇EnemyBook.js 备注
 * 
 *  - By 1.27 version updating,
 *   新增描述行数增加
 *   请在插件参数"描述行数"中设置您想要显示的行数。最大行数为无限
 * 
 * <desc1:burabura>
 *   这是第1行描述
 ...
 * 
 *   〇v1.21
 *   当将插件参数 使用检查敌人信息技能时隐藏未知敌人的状态 设置为开启时，
 *   可以显示未知敌人的状态为 "???"。
 * 
 * 可以通过设置插件参数来设置这两个技能的消息。
 * 
 * ============================================================================
 * 状态备注
 * ============================================================================
